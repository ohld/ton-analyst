...
|------|-------|-------------|
| [../assets.md](../assets.md) | Core constants | Native TON and canonical USDT addresses, decimals, balance snippets |
...
| `result_sybil_wallets` | Sybil/bot/scammer automation addresses (~335K after safer 2026-05-29 update) | [Q5206440](https://dune.com/queries/5206440) | [accounts.md](accounts.md) |
...
| `result_external_balances_history` | DeFi position changes | [Q5622650](https://dune.com/queries/5622650) | [balances.md](balances.md) |
