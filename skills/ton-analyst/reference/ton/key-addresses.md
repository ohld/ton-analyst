# Key Addresses and Entity Labels
...
Many DeFi pool contracts are NOT in `dataset_labels`. Build DEFI_LABELS CTE from `result_dex_pools_latest` + `result_external_balances_history`. See [labels-real-users.md](../dune/patterns/labels-real-users.md) for the full CTE.
